...
module.exports = {
    ...
    getProducts: async (req, res) => {
        try {
            const { page, limit, TenSP, sort, order, locTheoLoai, locTheoGia, GiamGiaSP, tu, den, isActive, IdLoaiSP } = req.query; 
    ...
    createProduct: async (req, res) => {
        try {
            let {TenSP, GiaBan, GiamGiaSP, urlYoutube, MoTa, ImageSlider, Image, IdLoaiSP, SoLuongTon, Note, urlDriverVideo, sizes} = req.body                                      

            let createSP = await SanPham.create({TenSP, GiaBan, GiamGiaSP, urlYoutube, MoTa, ImageSlider, Image, IdLoaiSP, Note, urlDriverVideo, sizes})
    ...
    updateProduct: async (req, res) => {
        try {
            let {_id, TenSP, GiaBan, GiamGiaSP, urlYoutube, MoTa, ImageSlider, Image, IdLoaiSP, SoLuongTon, Note, urlDriverVideo, sizes} = req.body

            let updateTL = await SanPham.updateOne({_id: _id},{TenSP, GiaBan, GiamGiaSP, urlYoutube, MoTa, ImageSlider, Image, IdLoaiSP, SoLuongTon, Note, urlDriverVideo, sizes})
