...
const { findThongBaoBanner, createThongBaoBanner, updateThongBaoBanner, showHiddenThongBao } = require("../controllers/ThongBao/thongBao.controller");
...
router.put("/show-hidden-thong-bao", showHiddenThongBao );
